...
class TestLevelTransition:
    ...
    def test_l2_to_l3_transition(self, temp_tracking_dir):
        ...
        # 验证 called_skills 保留 deep-thinking（累积模式）
        ...
        # 验证 L3 只需补 openclaw-behavior-plan
